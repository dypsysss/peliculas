 ...
 */
class JFormFieldSelectTMDBCompany extends JFormField
{
    /**
     * The form field type.
     */
    ...
    protected function getInput()
    {
        ...
        $link = 'index.php?option=com_peliculas&amp;view=tmdbcompanies&amp;layout=modal&amp;tmpl=component&amp;field=' . $this->id;
        ...
        // Build the script.
        $script = array();
        $script[] = '	function jSelectCompany_' . $this->id . '(id, title) {';
        ...
        $script[] = '		    Joomla.submitbutton("company.applytmdb");';
        $script[] = '		jModalClose();';
        $script[] = '	}';
