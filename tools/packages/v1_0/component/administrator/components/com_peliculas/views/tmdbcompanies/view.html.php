 ...
 */
class PeliculasViewTmdbCompanies extends PeliculasViewBase
{
    protected $items;
    protected $_TMDB;
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(JText::_('COM_PELICULAS_MANAGER_TMDBCOMPANIES'), 'peliculas-tmdbcompanies.png');
