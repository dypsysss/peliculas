 ...
 */
class PeliculasModelMovies extends PeliculasModelBaseList
{
    /**
     * Constructor.
     *
    ...
    protected function getListQuery()
    {
        ...
        $query->select(
            ...
            'a.published, a.access, a.featured, a.f_estreno,' .
        ...
        // $query->select('g.name AS gendersnames');
