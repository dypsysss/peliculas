...
/**
 * Peliculas companies view.
 *
 * @package     Joomla.Administrator
 * @subpackage  com_peliculas
 */
class PeliculasViewCompanies extends PeliculasViewBase
{
    protected $items;
    ...
    public function display($tpl = null)
    {
        ...
        PeliculasHelper::addSubmenu('companies');
        $this->addToolbar();
        parent::display($tpl);
    }
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(JText::_('COM_PELICULAS_MANAGER_COMPANIES'), 'peliculas-companies.png');
