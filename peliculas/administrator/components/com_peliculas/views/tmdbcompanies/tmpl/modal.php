...
$function  = 'jSelectCompany_' . $field;
$listOrder = $this->escape($this->state->get('list.ordering'));
$listDirn  = $this->escape($this->state->get('list.direction'));
?>
<form action="<?php echo JRoute::_('index.php?option=com_peliculas&view=tmdbcompanies&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
