 ...
 */
class PeliculasModelTmdbCompanies extends PeliculasModelBaseList
{
    ...
    public function getItems()
    {
        ...
        if (!empty($search)) {
            ...
            $result = $this->getTMDB()->_call('search/company', 'query='. urlencode($search) . '&page=' . $page, $this->getTMDB()->getLang());

            $items = array();
            if ($result['results']) {
                foreach ($result['results'] as $data) {
                    $items[] = new Company($data);
                }
            }
            ...
            // $items = $this->getTMDB()->searchCompany($search);
        } else {
            $items = null;
        }
