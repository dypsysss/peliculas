 ...
 */
class PeliculasModelTmdbMovies extends PeliculasModelBaseList
{
    ...
    public function getItems()
    {
        ...
        if (!empty($search)) {
            ...
            $result = $this->getTMDB()->_call('search/movie', 'query='. urlencode($search) . '&page=' . $page, $this->getTMDB()->getLang());

            $items = array();
            if ($result['results']) {
                foreach ($result['results'] as $data) {
                    $items[] = new Movie($data);
                }
            }
            ...
            // $items = $this->getTMDB()->searchMovie($search);
        } else {
            $items = null;
        }
