 ...
 */
class PeliculasViewTmdbMovies extends PeliculasViewBase
{
    protected $items;
    protected $_TMDB;
    ...
    public function display($tpl = null)
    {
        ...
        PeliculasHelper::addSubmenu('movies');
        $this->addToolbar();
        parent::display($tpl);
    }
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(JText::_('COM_PELICULAS_MANAGER_TMDBMOVIES'), 'peliculas-tmdbmovies.png');
