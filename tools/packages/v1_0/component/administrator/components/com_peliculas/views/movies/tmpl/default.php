...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_peliculas&task=movies.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_peliculas&view=movies'); ?>" method="post" name="adminForm" id="adminForm">
            ...
            <table class="table table-striped" id="articleList">
                ...
                <tr>
                    ...
                    <th width="5%" class="nowrap hidden-phone">
                        <?php echo JHtml::_('searchtools.sort', 'COM_PELICULAS_HEADING_MOVIE_RELEASEDATE', 'a.f_estreno', $listDirn, $listOrder); ?>
                    </th>
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td class="nowrap has-context">
                            <div class="pull-left">
                                ...
                                <?php endif; ?>
                                <?php if ($canEdit) : ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_peliculas&task=movie.edit&id=' . (int) $item->id); ?>">
                        ...
                        <td class="nowrap hidden-phone">
                            <?php echo JHtml::_('date', $item->f_estreno, JText::_('DATE_FORMAT_LC4')); ?> <i class="icon-calendar"></i>
                        </td>
