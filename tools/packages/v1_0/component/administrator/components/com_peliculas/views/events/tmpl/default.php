...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_peliculas&task=events.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_peliculas&view=events'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <?php else : ?>
            <table class="table table-striped" id="articleList">
                ...
                <tr>
                    ...
                    <th>
                        <?php echo JHtml::_('searchtools.sort', 'COM_PELICULAS_HEADING_EVENT_TITLE', 'a.name', $listDirn, $listOrder); ?>
                    </th>
                    <th width="10%" class="nowrap hidden-phone">
                        <?php echo JHtml::_('searchtools.sort', 'COM_PELICULAS_HEADING_CINEMA_TITLE', 'cinema_name', $listDirn, $listOrder); ?>
                    </th>
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td class="center">
                            <div class="btn-group">
                                ...
                                <?php // echo JHtml::_('jgrid.published', $item->published, $i, 'events.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
                            </div>
                        </td>
                        ...
                        <td class="nowrap has-context">
                            <div class="pull-left">
                                ...
                                <?php endif; ?>
                                <?php if ($canEdit) : ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_peliculas&task=event.edit&id=' . (int) $item->id); ?>">
                                ...
                                echo "<br/><small>" . implode('<br />', $tips) . "</small>";
                                ?>
                            </div>
                        </td>
