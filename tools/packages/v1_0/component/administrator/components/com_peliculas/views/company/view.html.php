 ...
 */
class PeliculasViewCompany extends PeliculasViewBase
{
    protected $form;
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title($isNew ? JText::_('COM_PELICULAS_MANAGER_COMPANY_NEW') : JText::_('COM_PELICULAS_MANAGER_COMPANY_EDIT'), 'bookmark peliculas-company');
