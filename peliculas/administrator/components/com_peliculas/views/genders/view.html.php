 ...
 */
class PeliculasViewGenders extends PeliculasViewBase
{
    protected $items;
    ...
    public function display($tpl = null)
    {
        ...
        PeliculasHelper::addSubmenu('genders');
        $this->addToolbar();
        parent::display($tpl);
    }
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(JText::_('COM_PELICULAS_MANAGER_GENDERS'), 'peliculas-genders.png');
        ...
        if ($canDo->get('core.edit.state'))
        {
            ...
            JToolbarHelper::checkin('genders.checkin');
        }
