 ...
 */
class PeliculasModelCompanies extends PeliculasModelBaseList
{
    /**
     * Constructor.
     *
    ...
    protected function getListQuery()
    {
        ...
        $query->select(
            'a.id, a.name, a.alias, a.image, a.homepage, a.headquarters, '.
            'a.published, a.access, ' .
            'a.ordering AS ordering, ' .
            'a.checked_out, a.checked_out_time, a.created_user_id'
        );

        $query->from($db->quoteName('#__peliculas_companies') . ' AS a');
