...
/**
 * Form Field class for Multiselect genders.
 *
 * @package     Joomla.Administrator
 * @subpackage  com_jpeliculas
 * @see         JFormField
 */
class JFormFieldSelectGenders extends JFormFieldList
{
    /**
     ...
     * @var    string
     */
    public $type = 'SelectGenders';

    /**
     * com_peliculas parameters
     *
     * @var    JRegistry
     */
    ...
    protected function getOptions()
    {
        ...
        $query->from('#__peliculas_genders AS a');
