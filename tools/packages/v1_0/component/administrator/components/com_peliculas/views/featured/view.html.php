 ...
 */
class PeliculasViewFeatured extends PeliculasViewBase
{
    protected $items;
    ...
    public function display($tpl = null)
    {
        ...
        PeliculasHelper::addSubmenu('featured');
        $this->addToolbar();
        parent::display($tpl);
    }
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(JText::_('COM_PELICULAS_MANAGER_FEATURED_MOVIES'), 'peliculas-featured-movies.png');
