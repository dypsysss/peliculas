 ...
 */
class PeliculasViewPerson extends PeliculasViewBase
{
    protected $form;
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title($isNew ? JText::_('COM_PELICULAS_MANAGER_PERSON_NEW') : JText::_('COM_PELICULAS_MANAGER_PERSON_EDIT'), 'bookmark peliculas-person');
