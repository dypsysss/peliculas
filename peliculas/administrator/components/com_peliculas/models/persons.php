 ...
 */
class PeliculasModelPersons extends PeliculasModelBaseList
{
    /**
     * Constructor.
     *
    ...
    protected function getListQuery()
    {
        ...
        $query->select(
            ...
            'a.birthday, a.deathday, a.homepage, a.place_of_birth, '.
            'a.published, a.access, ' .
            'a.ordering AS ordering, ' .
            'a.checked_out, a.checked_out_time, a.created_user_id'
        );

        $query->from($db->quoteName('#__peliculas_persons') . ' AS a');
