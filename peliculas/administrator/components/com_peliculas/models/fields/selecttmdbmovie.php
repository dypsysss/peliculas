 ...
 */
class JFormFieldSelectTMDBMovie extends JFormField
{
    /**
     * The form field type.
     */
    protected $type = 'SelectTMDBMovie';
    ...
    protected function getInput()
    {
        ...
        $link = 'index.php?option=com_peliculas&amp;view=tmdbmovies&amp;layout=modal&amp;tmpl=component&amp;field=' . $this->id;
        ...
        // Build the script.
        $script = array();
        $script[] = '	function jSelectMovie_' . $this->id . '(id, title) {';
        ...
        $script[] = '		    Joomla.submitbutton("movie.applytmdb");';
        $script[] = '		jModalClose();';
        $script[] = '	}';
